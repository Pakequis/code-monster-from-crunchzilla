...
var lessons =
	[
		...
		// Desenha uma caixa
		{ message: "Eu sou o Code Monster! (Clique no que eu digo parar avançar)", 
		  code: "c.fillRect(20, 20, 50, 75);\n",
		  lessonSection: "Começando",
		  tutorImage: 1,
		...
		{ message: "Você vai aprender um pouco de programação! (Clique novamente)"
		},
		{ message: "Ali embaixo, a esquerda, está o código em Javascript e a direita o que ele faz."
		},
		{ message: "Você pode usar fillRect() para desenhar uma caixa. Viu o número 50? Você pode mudar para 150?", 
		  code: "c.fillRect(20, 20, 50, 75);\n",
		  youGotItCheck: "150",
		},
		{ message: "A caixa ficou mais larga. O que você acha que os outros números fazem? Tente troca-los.",
		  lessonSection: "Parâmetros e desenhos",
		},
		{ message: "Você percebeu? Os números indicam a distância do lado esquerdo para desenhar a caixa, a distância do topo, a largura da caixa e sua altura."
		},
		{ message: "Tente modificar todos os números!  Brinque com eles!",
		},
		{ message: "Duas caixas. Você pode trocar os números para que fiquem maiores?",
		  code: "c.fillRect(20, 20, 50, 75);\nc.fillRect(100, 100, 60, 80);\n"
		},
		{ message: "Você consegue trocar os números para movê-las?"
		},
		{ message: "Você consegue trocar os números de forma a uma cobrir a outra?"
		},

		// Variáveis
		{ message: "O Code Monster gosta de caixas quadradas.", 
		  code: "c.fillRect(20, 20, 80, 80);\n"
		},
		{ message: "Um quadrado tem altura e largura iguais. Esta caixa tem a mesma altura e largura, ambos são 80.",
		  code: "c.fillRect(20, 20, 80, 80);\n"
		},
		{ message: "Ei, veja, isso faz a mesma coisa!", 
		  code: "var size = 80;\nc.fillRect(20, 20, size, size);\n",
		  lessonSection: "Variáveis",
		  // tutorImage: 2,
		},
		{ message: "Por que ele faz a mesma coisa? Tem alguma ideia?",
		},
		{ message: "var significa variável. O que fizemos foi criar uma variável, chama-la <span class=tutor-code>size</span>, colocar seu valor igual a 80 e agora podemos usar <span class=tutor-code>size</span> onde usaríamos 80. Você sabe por que queremos fazer assim?",  
		  code: "var size = 80;\nc.fillRect(20, 20, size, size);\n"
		},
		{ message: "O que acontece se trocarmos 80 por 220?"
		},
		{ message: "Veja! Uma caixa maior e mais alta, tudo ao mesmo tempo!"
		},
		{ message: "Você pode mudar os outros números para mover a caixa?"
		},
		{ message: "Você consegue fazer a caixa muito pequena?"
		},
		{ message: "O que acontece se fizer <span class=tutor-code>size</span> igual a 0? Ou trocar para algo realmente grande, tipo 5000?"
		},

		// Mais caixas
		{ message: "O Code Monster quer duas caixas.", 
		  code: "var size = 80;\nc.fillRect(20, 20, size, size);\nc.fillRect(90, 90, size, size);\n"
		},
		{ message: "As duas caixas tem o mesmo tamanho.  Isso é um truque."
		},
		{ message: "Você pode mudar o valor de <span class=tutor-code>size</span>.  A caixa irá aumentar ou diminuir as duas caixas ao mesmo tempo! Tente mudar de 80 para 180!"
		},
		{ message: "Você consegue mover cada uma das caixas mudando alguns dos números?"
		},
		{ message: "O Code Monster quer mais caixas.  Três caixas!", 
		  code: "var size = 80;\nc.fillRect(20, 20, size, size);\nc.fillRect(80, 80, size, size);\nc.fillRect(140, 140, size, size);\n"
		},
		{ message: "O que acontece agora quando você muda o valor de <span class=tutor-code>size</span>?",
		},
		{ message: "Mais caixas! Agora tente mudar os tamanhos!", 
		  code: "var size = 80;\nc.fillRect(20, 20, size, size);\nc.fillRect(60, 60, size, size);\nc.fillRect(100, 100, size, size);\nc.fillRect(140, 140, size, size);\nc.fillRect(180, 180, size, size);\n"
		},

		// Duas caixas coloridas
		{ message: "Oh! Cores! Lindo!", 
		  code: "var size = 80;\n\nc.fillStyle = \"blue\";\nc.fillRect(20, 20, size, size);\n",
		  lessonSection: "Cores",
		},
		{ message: "Outras cores também funcionam. Tente \"green\" (verde) ou \"purple\" (roxo) ou \"gold\" (dourado)."
		},
		{ message: "O que acha de duas caixas rosas?", 
		  code: "var size = 80;\n\nc.fillStyle =\"pink\";\nc.fillRect(20, 20, size, size);\nc.fillRect(90, 90, size, size);\n"
		},
		{ message: "Uma rosa e uma prateada.", 
		  code: "var size = 80;\n\nc.fillStyle =\"pink\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"silver\";\nc.fillRect(90, 90, size, size);\n"
		},
		{ message: "Você consegue fazer a caixa prateada virar dourada? E mudar a rosa para azul?", 
		  code: "var size = 80;\n\nc.fillStyle =\"pink\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"silver\";\nc.fillRect(90, 90, size, size);\n"
		},
		{ message: "Aqui temos duas caixas da mesma cor, de novo.  Agora, você consegue fazer as duas caixas mudarem de cor?",
		  code: "var size = 80;\n\nc.fillStyle =\"green\";\nc.fillRect(20, 20, size, size);\n\nc.fillRect(90, 90, size, size);\n"
		},
		{ message: "Aqui temos uma versão. Gosto de vermelho e azul.", 
		  code: "var size = 80;\n\nc.fillStyle =\"red\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"blue\";\nc.fillRect(80, 80, size, size);\n"
		},
		{ message: "Vermelho (Red), verde (green), e azul (blue). Ficou legal.",
		  code: "var size = 80;\n\nc.fillStyle =\"red\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"lime\";\nc.fillRect(80, 80, size, size);\nc.fillStyle =\"blue\";\nc.fillRect(140, 140, size, size);\n"
		},
		{ message: "Uá... Isso faz a mesma coisa! O que esse tal de rgb() faz?",
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(255, 0, 0)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"rgb(0, 255, 0)\";\nc.fillRect(80, 80, size, size);\nc.fillStyle =\"rgb(0, 0, 255)\";\nc.fillRect(140, 140, size, size);\n"
		},
		{ message: "Tente mudar os zeros para 200. E tente mudar qualquer um dos 255 para zero. O que os números parecem fazer?", 
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(255, 0, 0)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"rgb(0, 255, 0)\";\nc.fillRect(80, 80, size, size);\nc.fillStyle =\"rgb(0, 0, 255)\";\nc.fillRect(140, 140, size, size);\n"
		},
		{ message: "Você notou? rgb() se refere ao vermelho, verde e azul.  Os números vão de 0 a 255. Então, <span class=tutor-code>rgb(0, 255, 0)</span> significa sem vermelho ou azul, mas com tudo no verde!"
		},
		{ message: "Você consegue criar muitas cores desta forma, só mexendo nos números. Tente!"
		},
		{ message: "Agora um jogo divertido. Você consegue fazer essas duas caixas ficarem da mesma cor?",
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(0, 0, 0)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"red\";\nc.fillRect(80, 80, size, size);\n",
		  lessonSection: "Quiz: Cores",
		},
		{ message: "Consegue fazer ambas azuis?",
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(0, 0, 0)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"blue\";\nc.fillRect(80, 80, size, size);\n"
		},
		{ message: "Consegue achar quais os números em rgb() para que ambas fiquem amarelas?",
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(255, 0, 0)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"yellow\";\nc.fillRect(80, 80, size, size);\n"
		},
		{ message: "Consegue achar quais os números em rgb() para que ambas fiquem verde escuro?",
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(0, 0, 128)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"teal\";\nc.fillRect(80, 80, size, size);\n"
		},
		{ message: "Bom, esta vai ser dificil. Conseuge fazer as duas exatamente iguais? Consegue achar os números em rgb() para que ambas fiquem vermelho esucro? Não se preocupe se não conseguir, apenas tente se aproximar da cor certa!",
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(0, 0, 0)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"crimson\";\nc.fillRect(80, 80, size, size);\n"
		},
		{ message: "Tá aqui. Nha, essa foi dificil! Quão perto você chegou?",
		  code: "var size = 80;\n\nc.fillStyle =\"rgb(220, 20, 60)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"crimson\";\nc.fillRect(80, 80, size, size);\n"
		},
		{ message: "Se quiser tentar outras cores, coloque \"olive\" (verde oliva), \"purple\" (purpura), \"aqua\" (ciano) ou qualquer outra cor que você imaginar para a primeira caixa, depois tente achar os números rgb que batem!",
		},


		// rgba
		{ message: "rgba() é uma versão maluca do rgb(). Viu o que ela faz? Tem mais um número (0.5) no final. O que esse último número faz? Tente trocá-lo de 0.5 para 0.1. Ou para 0.8. O que ele faz?", 
		  code: "var size = 80;\n\nc.fillStyle =\"rgba(255, 0, 0, 0.5)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"rgba(0, 0, 255, 0.5)\";\nc.fillRect(80, 80, size, size);\n",
		  lessonSection: "Cor e transparência",
		},
		{ message: "O a no rgba siginifica alpha (quantidade de transparência de uma caixa) de 0.0 (invisível) até 1.0 (sólida)."
		},
		{ message: "Você pode fazer algumas coisas legais com rgba(). Veja isso! Tente mudar algum dos 0.5 alpas para 0.2 ou 0.8!",
		  code: "var size = 80;\n\nc.fillStyle =\"rgba(255, 0, 0, 0.5)\";\nc.fillRect(20, 20, size, size);\nc.fillStyle =\"rgba(0, 255, 0, 0.5)\";\nc.fillRect(80, 80, size, size);\nc.fillStyle =\"rgba(0, 0, 255, 0.5)\";\nc.fillRect(140, 140, size, size);\n"
		},
		{ message: "Tente mudar o tamanho de 80 para 180! Você consiguirá alguns efeitos divertidos sobrepondo as cores. Brinque à vontade!",
		},
		...
		{ message: "Let's go back to variables. Monster no like to repeat numbers. Can you replace both the 20 numbers with <span class=tutor-code>offset</span>?",
		  code: "var offset = 30;\nvar size = 80;\nc.fillStyle =\"lime\";\nc.fillRect(20, 20, size, size);\nc.fillRect(90, 90, size, size);\n",
		  lessonSection: "Operadores e atribuições",
		  // tutorImage: 3,
		},
